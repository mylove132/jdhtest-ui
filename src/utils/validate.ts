 ...
 * 多选
 */
export const NotSelect = (str: string) => {
  return {
    required: true,
    message: `请选择${str}`,
    trigger: 'change',
 ...
 *  单选， 值类型任意
 */
export const NotRadio = (str: string) => {
  return {
    required: true,
    message: `请选择${str}`,
    trigger: 'change',
 ...
 * @param {字符串最大长度} max
 */
export const limitStr = (str: string, min = 3, max = 8) => {
  return {
    required: true,
    min,
    max,
 ...
 * @param {字符串最大长度} max
 */
export const nickStr = (str: string, min = 3, max = 8) => {
  return {
    required: true,
    pattern: /^\w+$/,
    min,
 ...
 */
export const phoneStr = (inlcudeTel?: boolean) => {
