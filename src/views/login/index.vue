...
const validateComfirmPass = async (value: string) => {
...
const submitLogin = async (data: any) => {
  ...
  const res = await login(data).catch((err: Error) => {
    console.log(err)
  ...
  if (res) {
    ...
    Router.push({
      path: route.query.redirectUrl as string || '/',
    })
  }
}
const resetForm = () => {
